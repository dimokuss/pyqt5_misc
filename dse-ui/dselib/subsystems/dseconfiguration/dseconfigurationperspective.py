...
from dselib.subsystems.dseconfiguration.dseconfigurationmodel import DseConfigurationModel
from dselib.subsystems.dseconfiguration.dseconfigurationview import DseConfiguratonView

class DseConfigurationPerspective(Perspective):
    """
    ...
    def load_view(self):
        ...
        self.model = DseConfigurationModel(self.context)
        self.set_model(self.model)
        # create the view that will display the model
        self.view = DseConfiguratonView(self)
        # return the view
        return self.view
