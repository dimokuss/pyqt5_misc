...
from dselib.subsystems.dsesetup.dsesetupmodel import DseSetupModel
from dselib.subsystems.dsesetup.dsesetupview import DseSetupView

class DseSetupPerspective(Perspective):
    """
    ...
    def load_view(self):
        ...
        self.model = DseSetupModel(self.context)
        self.set_model(self.model)
        # create the view that will display the model
        self._view = DseSetupView(self)
        # return the view
        return self.view
